...
pub fn cleanup_script() -> &'static str {
    "(()=>{'use strict';delete globalThis.__DSH_DESKTOP_SKIN_PENDING__;document.getElementById('dsh-desktop-skin-style')?.remove();document.getElementById('dsh-desktop-skin-background')?.remove();})();"
}
