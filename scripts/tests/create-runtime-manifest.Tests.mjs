...
test("CLI 以 canonical UTF-8 JSON 加单个换行写入新文件", async () => {
  ...
  const expected =
    '{"schema":1,"dsh_version":"0.1.1-rc.2","node_version":"24.15.0","minimum_desktop_version":"0.1.0","platform":"windows","arch":"x86_64","artifact":{"url":"https://github.com/ccx-dym/dsh-gui/releases/download/dsh-v0.1.1-rc.2-windows/dsh-runtime-0.1.1-rc.2-node-24.15.0-win-x64.zip","size":7,"sha256":"f16d05ec6b29248d2c61adb1e9263f78e4f7bace1b955014a2d17872cfe4064d"},"verified_at":"2026-08-22T00:00:00Z","compatibility_summary":"Windows 10/11 x64 核心兼容验证通过；皮肤未验证时自动关闭。"}\n';
